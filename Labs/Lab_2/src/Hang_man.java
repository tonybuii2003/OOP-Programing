 ...
 * The game moves on. After user input the word, the game will check if the word match its word.
 * If the word doesn't match, the user's word will replace into the blank. Else the user will lose 1 turn.
 * The game only end when the user win (ALL THE WORDS MATCHED) or lost (OUT OF TURN)
 */
